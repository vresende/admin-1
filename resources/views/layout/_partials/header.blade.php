<header class="header-container pt-2 pb-2 m-0 w-100 bg-primary">
    <div class="container-fluid">
        <div class="row">
            <div class="col-5 col-md-4">
                <a href="{{ route('admin.home') }}" class="img-fluid">
                    <img class="logo-img" src="https://placehold.co/500x70" alt="" title="">
                </a>
            </div>
            <div class="col-7 col-md-8 d-flex justify-content-end align-items-center">
                ...
                <div class="d-flex justify-content-end align-items-center">
                    <div class="cursor-pointer">
                            <i class="bi bi-sun-fill dropdown-icon-notification mr-5 text-warning theme-color"></i>
                    </div>
                    <!-- BEGIN TOPBAR USER  -->
                    <div class="dropdown">
                        <div class="dropdown-toggle" type="button" id="dropdownMenuButton1"
                             data-bs-toggle="dropdown" aria-expanded="false">
                            <img src="https://i.pravatar.cc/300" class="header-avatar" alt="">
                            <span class="ms-2 text-light">Nome do Usuário</span>
                        </div>
                        <ul id="dr" class="dropdown-menu pt-3 dropdown-avatar" data-aos="fade-up">
            ...
            <ul class="navbar-nav flex-row ms-auto breadcrumb-action-dropdown">
                <li class="nav-item more-dropdown">
                    <div class="dropdown  custom-dropdown-icon">
                        <a class="btn btn-outline-dark" href="#" role="button" id="customDropdown" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                        ...
                        <div class="dropdown-menu dropdown-menu-right bg-light" aria-labelledby="customDropdown">
